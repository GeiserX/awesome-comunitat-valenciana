...
El criterio fundamental es: **se acepta software que da soporte específico a Comunitat Valenciana, no software hecho por alguien de Comunitat Valenciana.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Comunitat Valenciana. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Comunitat Valenciana no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Comunitat Valenciana o una integración con servicios públicos de Comunitat Valenciana sí.

- **Sí:** Clientes de APIs de instituciones de Comunitat Valenciana, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Comunitat Valenciana.
- **No:** Librerías genéricas creadas por equipos de Comunitat Valenciana, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Comunitat Valenciana** (no simplemente que el autor es de Comunitat Valenciana).
2. Verificar que la PR incluye la **URL del servicio o institución de Comunitat Valenciana** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-comunitat-valenciana`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Comunitat Valenciana |
