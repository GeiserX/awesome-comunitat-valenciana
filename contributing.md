# Contribuir a Awesome Comunitat Valenciana
...
- El proyecto debe **dar soporte específico a la Comunitat Valenciana** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución valenciana** a la que el software da soporte (p.ej. gva.es, uv.es, upv.es). Esto ayuda a verificar que el proyecto es relevante para la Comunitat Valenciana.
